...
```powershell
uv run python skills/pptify-tooling/scripts/design/design_context_catalog.py --profile fluent-ui-design-tokens --profile awesome-copilot-design-agents --include-context --pretty
```
