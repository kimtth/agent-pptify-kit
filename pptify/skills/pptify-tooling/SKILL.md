...
2. If `skills/pptify-tooling/scripts/` is missing, read `references/toolkit-setup.md` before responding.
3. Ask before cloning or installing any optional external toolkit.
...
| `skills/pptify-tooling/scripts/` found | `pyproject.toml` found | Action |
|---|---|---|
| Yes | Yes | Proceed: run `uv run python skills/pptify-tooling/scripts/...` commands normally |
