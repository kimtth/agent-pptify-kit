...
- When source-backed design context from `skills/pptify-tooling/resources/design` is used, record selected profile IDs, source URLs, and license IDs in `summary.design_context`.
