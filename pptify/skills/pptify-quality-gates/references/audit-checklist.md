...
- **Fail — any of the following:**
  - `summary.design_context` absent -> load a `skills/pptify-tooling/resources/design` profile (see `references/design-profiles.md` in `pptify-context-prep`) and rebuild.
