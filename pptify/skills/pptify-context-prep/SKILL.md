...
- Convert long source documents to markdown before planning slides: `uv run python skills/pptify-tooling/scripts/documents/document_to_markdown.py --source source.pdf --output-path source.md`.
- Build a structured summary tree when a source is long or multi-topic: `uv run python skills/pptify-tooling/scripts/documents/document_to_raptor_tree.py --markdown-path source.md --output-path source-summary.json --title "Source" --pretty`.
...
Use profiles from `skills/pptify-tooling/resources/design/sources.json`; do not invent a new design template when the user asks for predefined templates.
...
```powershell
uv run python skills/pptify-tooling/scripts/design/design_context_catalog.py --list --pretty
uv run python skills/pptify-tooling/scripts/design/design_context_catalog.py --profile fluent-ui-design-tokens --include-context --pretty
uv run python skills/pptify-tooling/scripts/design/design_context_catalog.py --profile primer-primitives --include-context --pretty
uv run python skills/pptify-tooling/scripts/design/design_context_catalog.py --profile corazzon-pptx-design-styles --include-context --pretty
```
...
6. Do not treat `skills/pptify-tooling/resources/design` profiles as content source material; they are design context only.
