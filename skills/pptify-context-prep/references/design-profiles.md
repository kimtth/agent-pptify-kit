...
Source: `resources/design/sources.json` — updated 2026-05-20.  
Load this file when `scripts/design/design_context_catalog.py` is unavailable.
...
```powershell
uv run python scripts/design/design_context_catalog.py --profile <profile-id> --include-context --pretty
```
