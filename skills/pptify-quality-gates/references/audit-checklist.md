...
Load this file when `scripts/audit/audit.py` is unavailable.  
...
- **Fail — any of the following:**
  - `summary.design_context` absent → load a `resources/design` profile (see `references/design-profiles.md` in `pptify-context-prep`) and rebuild.
