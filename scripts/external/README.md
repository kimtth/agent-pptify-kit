...
Restores `all-MiniLM-L12-v2/model_quantized.onnx`, `tokenizer.json`, and `tokenizer_config.json` from the Hugging Face `sentence-transformers/all-MiniLM-L12-v2` repository.
