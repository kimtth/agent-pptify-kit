...
DEFAULT_MANIFEST_PATH = Path(__file__).resolve().parents[2] / "resources/design" / "sources.json"
...
def build_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument("--manifest", type=Path, default=DEFAULT_MANIFEST_PATH, help="Path to resources/design/sources.json.")
